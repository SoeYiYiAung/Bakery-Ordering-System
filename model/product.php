   ...
   public function getProductId($id)
    {
        $this->pdo = Database::connection();
        $this->pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "Select products.id from order_details where order_details.product_id=$id ";//join categories where  products.category_id=categories.id
    ...
    public function getCustomizeProductId($id)
    {
        $this->pdo = Database::connection();
        $this->pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "Select customize_order_details.product_id from customize_order_details where customize_order_details.product_id=$id ";//join categories where  products.category_id=categories.id
        $statement = $this->pdo->prepare($sql);
        $statement->execute();
        $result = $statement->fetchAll(pdo::FETCH_ASSOC);
        return $result;
