            ...
            <div class="row">
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        ...
                        ?>
                        <ul>
                            <li class="<?php  echo ($active == '/sweet_cake/index.php')? 'active':''; ?>"><a
                                    href="./index.php">Home</a></li>
                            <li class="<?php echo ($active == '/sweet_cake/about.php')? 'active':''; ?>"><a
                                    href='./about.php'>About</a></li>
                            <li class="<?php echo ($active == '/sweet_cake/shop.php' ? 'active' :'') ?>"><a
                                    href="./shop.php">Shop</a></li>
                            <li class="<?php echo ($active == '/sweet_cake/customize.php' ? 'active' :'') ?>">
                                <a href="./customize.php">Customize</a>
                            </li>
                            <!-- <li class="<?php  echo($active == '/sweet_cake/shoping-cart.php'?'active':'')  ?>">
                                <a href="./shoping-cart.php">Shoping Cart</a>
                            </li> -->
                            <li class="<?php echo($active == '/sweet_cake/contact.php')?'active':''  ?>"><a
